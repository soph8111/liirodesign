...
<script>
    ...
    function visSmykker() {
        ...
        let container = document.querySelector("#quirky_smykker"); // Opretter variablen til hvor templatesene skal klones i
        smykker.forEach(smykke => { // Looper igennem "smykker-arrayet". Får hvert smykke skal det efterfølgende ske:
            if (smykke.kollektion == 16) { // hvis smykke-arrayet indeholder kollektions id 16 - quicky kollektionens id, så ske følgende:
                ...
                klon.querySelector(".article_quirky").addEventListener("click", () => {
